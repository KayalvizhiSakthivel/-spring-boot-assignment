...
<body>
	...
	<h1 align="center">Search Subject</h1>
	<form:form action="searchSubject" method="POST"
			...
			<table id="bio">
				<thead>
					<tr>
						...
						<th id="imd">Subject Id</th>
						<th id="imd">Subject Title</th>
						<th id="imd">Duration</th>

					</tr>
				</thead>
				<tbody>
					<c:forEach var="subject" items="${recs }">
						<tr>
