...
<body>
	...
	<form:form action="addBook" method="POST" modelAttribute="book">
		<table>
			<tr>
				<td>Book Id</td>
				<td><form:input path="bookId" type="number" required="required" /></td>
			</tr>
			<tr>
				<td>Book Title</td>
			...
			<tr>
				<td>Volume</td>
				<td><form:input path="volume" type="number" required="required" /></td>
			</tr>
			<tr>
				<td>Publish Date</td>
				<td><form:input path="publishDate" type="date"
