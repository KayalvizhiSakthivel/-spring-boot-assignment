...
<body>
	...
	<h1 align="center">Delete Subject</h1>
	<form:form action="deleteSubject" method="POST"
		modelAttribute="subject">
		<c:out value="${s}"></c:out>
		<table>
			<tr>
				<td>Subject Id</td>
				<td><input name="subjectId" type="number" required="required" /></td>
			</tr>

			<tr>
				<td><input class="btn btn-lg" type="submit" name="submit"
					value="Delete Subject"></input></td>
			</tr>
		</table>
	</form:form>
