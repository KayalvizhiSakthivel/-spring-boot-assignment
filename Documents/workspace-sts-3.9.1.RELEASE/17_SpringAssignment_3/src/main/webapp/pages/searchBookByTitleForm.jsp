...
<body>
	...
	<h1 align="center">Search Book By Title</h1>
	<form:form action="searchBookByTitle" method="POST"
		modelAttribute="book">
		<table>
			<tr>
				<td>Book Title</td>
			...
			<tr>
				<td><input class="btn btn-lg" type="submit" name="submit"
					value="Search Book"></input></td>
			</tr>
		</table>
		<br>
		<table id="bio">
			<tr id="imd">
				<td id="imd">Book Id</td>
				<td id="imd">Book Title</td>
				<td id="imd">Price</td>
				<td id="imd">Volume</td>
				<td id="imd">Date</td>
			</tr>
